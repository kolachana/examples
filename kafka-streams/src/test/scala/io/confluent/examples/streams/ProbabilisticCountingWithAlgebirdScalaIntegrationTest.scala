...
/**
  ...
  */
class ProbabilisticCountingWithAlgebirdScalaIntegrationTest extends AssertionsForJUnit {
  ...
  def startKafkaCluster() {
    // TODO: Demonstrate counting with 2+ partitions for the input topic, which requires merging CMS instances
  ...
  def shouldProbabilisticallyCountWords() {
    ...
    class ProbabilisticCounter extends Transformer[String, String, KeyValue[String, Long]] {
      ...
      override def transform(k: String, v: String): KeyValue[String, Long] = {
        cmsState.put(v)
        ...
        KeyValue.pair[String, Long](v, cmsState.get(v))
      }
